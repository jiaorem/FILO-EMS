                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="{{ url('employee/profile/'.$items->rec_id) }}">{{ $items->name }}</a>
                                        </h2>
                                    </td>
                                    <td>{{ $items->rec_id }}</td>
                                    <td>{{ $items->email }}</td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">  
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="employee_id" name="employee_id" placeholder="Auto Employee ID" readonly>
                                    </div>
                                </div>
                            </div>
