        ...
        <div class="account-content">
            <div class="container">
                ...
                <div class="account-logo">
                    <a href="index.html"><img src="{{ URL::to('assets/img/filo2.png') }}"></a>
                </div>
                <!-- /Account Logo -->
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                    <label class="col-form-label">Role Name</label>
                                        <input type="text" class="form-control" id="role_name" name="role_name" value="Admin" placeholder="Admin" readonly>
                            </div>
                            <div class="form-group">
